...
function kdw_enqueue_template_scripts() {
    ...
    //wp_enqueue_script( 'kdw-niceselect', get_stylesheet_directory_uri() . "/js/jquery.nice-select-custom.min.js", array( 'jquery' ) );
    ...
    wp_enqueue_style('main-style',get_template_directory_uri() . '/style.css',array(),'0.51');
